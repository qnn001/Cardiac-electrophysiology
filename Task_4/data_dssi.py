...
def read_data(data_dir: Union[str, Path] = "data"):
    ...
    for lf1,lf2 in file_pairs:
        ...
        x2 = ct.get_activation_time(x2) # (75,1) # for task 4 remove this line.
    ...
    col2 = np.vstack(col2)
    scaler = MinMaxScaler()
    normalized_data = scaler.fit_transform(col2)
    joblib.dump(scaler, scaler_path)

    a_f2 = np.vsplit(normalized_data, num_sub)
    a_f2 = [i.reshape(75,-1) for i in a_f2]
